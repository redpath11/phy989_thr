...
//  m_mass = 1.0;// [Mn]
  ...
  m_Lambda = 0.343;// ~ 1/2 pion mass [1/fm]
//  m_Lambda = 3.430;// ~ 1/2 pion mass * 10 [1/fm]
//  m_Lambda = 0.0343;//~ 1/2 pion mass / 10 [1/fm]
//  m_Lambda = 0.943;// ~ 1/2 pion mass * 3 [1/fm]
//  m_Lambda = 2.8;// ~ mass in the Vb Yukawa term [1/fm]
}
...
double NucleonScattering::GetLambda(){ return m_Lambda; }
void NucleonScattering::SetLambda(double setLambda){ m_Lambda = setLambda; }
...
void NucleonScattering::OnePionLO(double C0){
if(m_momentaSet){
  m_potential = (double **) matrix(m_meshPoints+1,m_meshPoints+1,sizeof(double));
...
else{cout << "Run MapPoints() first." << endl;}
}


void NucleonScattering::OnePionNLO(double C0,double C2){
if(m_momentaSet){
  m_potential = (double **) matrix(m_meshPoints+1,m_meshPoints+1,sizeof(double));
...
void NucleonScattering::OnePionNNLO(double C0,double C2,double C4,double C4p){
if(m_momentaSet){
  m_potential = (double **) matrix(m_meshPoints+1,m_meshPoints+1,sizeof(double));
