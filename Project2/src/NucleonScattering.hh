...
public:
  ...
  void PotentialNP();
  void eftLO(double);
  void eftNLO(double,double);
  void eftNNLO(double,double,double,double);
  void OnePionLO(double);
  void OnePionNLO(double,double);
  void OnePionNNLO(double,double,double,double);
  void SetMatrixA();
//  void PhaseShift();
  double PhaseShift();
